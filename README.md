...
| 02 | [JPetStore Login Automation](02-jpetstore-login-automation/) | Selenium (POM) automation suite for a login flow | [JPetStore demo](https://petstore.octoperf.com/) | Complete |
